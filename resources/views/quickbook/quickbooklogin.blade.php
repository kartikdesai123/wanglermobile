    ...
    <script>
        ...
        var apiCall = function() {
            ...
            this.getInvoice = function() {
                /*
                AJAX Request to retrieve getInvoice
                 */
                $.ajax({
                    type: "GET",
...
<div class="container">
    ...
    <pre id="accessToken">
      <p style="background-color:#efefef;overflow-x:scroll"><?php $displayString = isset($accessTokenJson) ? $accessTokenJson : "No Access Token Generated Yet"; echo json_encode($displayString, JSON_PRETTY_PRINT); ?></p>
    </pre>
    ...
    <button  type="button" class="btn btn-success" onclick="apiCall.getInvoice()">Get Invoice</button>
    <button  type="button" class="btn btn-success" onclick="apiCall.getProduct()">Get Product</button>
    <button  type="button" class="btn btn-success" onclick="apiCall.getCustomer()">Get Customer</button>
